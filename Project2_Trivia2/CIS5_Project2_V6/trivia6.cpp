 ...
 * Purpose: CIS5 Project 2 Trivia Game Version 5
 */
...
//*Main Menu Prototypes
    void gameMenu(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void gameTutorial(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void aboutProg(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void triviaGame(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
//*Trivia Question Prototypes for 5 questions
    void question1(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void question2(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void question3(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void question4(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void question5(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);   
//*Bonus Trivia Question Prototypes for 5 Questions
    bool initBonus(int score);
    void bonusQ1(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void bonusQ2(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void bonusQ3(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void bonusQ4(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void bonusQ5(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
//* Check Answer Prototype
    bool checkAns(char userA, char ans, int &score, int &correct, int &incorrect, string div);
//*Solutions for regular questions and bonus game questions Prototypes
    void gameSolution(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
    void bonusgameSolution(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
 //*Game Over Screen Prototype
    void gameOver(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div);
...
void question4(string quest[], string questB[], int &score, int &correct, int &incorrect, string name, string div) { //*question 4 definition
    char userA; //*user answer
